...
public class WeeklyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myDH = new MyDatabaseHelper(WeeklyActivity.this);
        ...
        customAdapter = new CustomAdapter(WeeklyActivity.this, this, plan_id, plan_title, plan_priority,
                plan_time, plan_category);
        recycler.setAdapter(customAdapter);
        recycler.setLayoutManager(new LinearLayoutManager(WeeklyActivity.this));
    }

    public void storeData(){
        Cursor cursor = myDH.selectWeekly();
