...
public class HealthActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myDH = new MyDatabaseHelper(HealthActivity.this);
        ...
        customAdapter = new CustomAdapter(HealthActivity.this, this, plan_id, plan_title, plan_priority,
                plan_time, plan_category);
        recycler.setAdapter(customAdapter);
        recycler.setLayoutManager(new LinearLayoutManager(HealthActivity.this));
    }

    public void storeData(){
        Cursor cursor = myDH.selectHealth();
