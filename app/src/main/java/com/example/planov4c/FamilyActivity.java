...
public class FamilyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myDH = new MyDatabaseHelper(FamilyActivity.this);
        ...
        customAdapter = new CustomAdapter(FamilyActivity.this, this, plan_id, plan_title, plan_priority,
                plan_time, plan_category);
        recycler.setAdapter(customAdapter);
        recycler.setLayoutManager(new LinearLayoutManager(FamilyActivity.this));
    }

    public void storeData(){
        Cursor cursor = myDH.selectFamily();
