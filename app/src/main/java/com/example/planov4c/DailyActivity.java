...
public class DailyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myDH = new MyDatabaseHelper(DailyActivity.this);
        ...
        customAdapter = new CustomAdapter(DailyActivity.this, this, plan_id, plan_title, plan_priority,
                plan_time, plan_category);
        recycler.setAdapter(customAdapter);
        recycler.setLayoutManager(new LinearLayoutManager(DailyActivity.this));
    }

    public void storeData(){
        Cursor cursor = myDH.selectDaily();
