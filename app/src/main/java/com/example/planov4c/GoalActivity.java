...
public class GoalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myDH = new MyDatabaseHelper(GoalActivity.this);
        ...
        customAdapter = new CustomAdapter(GoalActivity.this, this, plan_id, plan_title, plan_priority,
                plan_time, plan_category);
        recycler.setAdapter(customAdapter);
        recycler.setLayoutManager(new LinearLayoutManager(GoalActivity.this));
    }

    public void storeData(){
        Cursor cursor = myDH.selectGoal();
